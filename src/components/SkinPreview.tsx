...
export function SkinPreview({ skin, size = 52, locked = false }: { skin: Skin; size?: number; locked?: boolean }) {
  ...
  useEffect(() => {
    ...
    drawSkinShape(ctx, skin.shape, skin.color, size * 0.45, size * 0.6, 8);
    ctx.restore();
  }, [skin, size, locked]);
